...
func getBroadcastsFromLiqui(liquipediaHTML *html.Node) []broadcastStream {
	SUPPORTED_STREAMS := []string{"rocketstreetlive", "rocketleague", "rocketleaguemena", "rocketleaguesam", "rocketleageueoce", "rocketleageueapac", "acgl alpha", "therocketrb", "dreamhack"}
