...
func getBroadcastsFromLiqui(liquipediaHTML *html.Node) []broadcastStream {
	SUPPORTED_STREAMS := []string{"rocketstreetlive", "rocketleague", "rocketleaguemena", "rocketleaguesam", "rocketleagueeoce", "rocketleagueapac", "acgl alpha", "therocketrb", "dreamhack", "rizzo", "rloceania", "oceaniarl", "oxg_esports", "rlesports"}
