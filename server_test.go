...
func TestTemplates(t *testing.T) {
	...
	fmt.Println(expectedEncodedMarkup)
	fmt.Println(responseMarkup)
	fmt.Println(expectedEncodedMarkup == responseMarkup)
...
func TestSchedule(t *testing.T) {
	...
	expectedEncodedMarkup := ""
	assert.Equal(t, expectedEncodedMarkup, string(responseData))
	...
	expectedEncodedMarkup = ""
	assert.Equal(t, expectedEncodedMarkup, string(responseData))
}
